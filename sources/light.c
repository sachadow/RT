...
/*   Updated: 2018/10/18 17:34:34 by sderet           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	c->red += l * currl.intensity.red * currm.diffuse.red / 255;
	c->green += l * currl.intensity.green * currm.diffuse.green / 255;
	c->blue += l * currl.intensity.blue * currm.diffuse.blue / 255;
}
